...
#%% Area selection
esio = pco2_1.sel(lat = slice(-6.6,8),lon = slice(92,109),mtime = slice('1960-1-1','2024-12-31'))
#%% eio
...
# --- 5. Final Layout ---
plt.suptitle('Mean pCO$_2$ Time Series for the Eastern Indian Ocean (6.6°S-8°N, 92°E-109°E)', fontsize=26)
