...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 20 12:41:32 2025
...
#%% Area selection
eio= co2_flux.sel(lat = slice(22.5, 28),lon = slice(56, 70),mtime = slice('1960-1-1','2024-12-31'))
...
plt.suptitle('Mean sea- air CO$_2$ flux Time Series for the Northern Arabian Sea (22.5°N-28°N, 56°E-70°E)', fontsize=26)
plt.tight_layout(rect=[0, 0, 1, 0.96]) # Adjust rect to make room for suptitle
plt.savefig('/home/bobco-08/24cl05012/CO2/plot/co2_flux/trend/nas_CO2F',dpi=600)
plt.show()