...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 20 00:35:09 2025
...
#%% Area selection
eio = co2_flux.sel(lat = slice(-6.5,5),lon = slice(49,92),mtime = slice('1960-1-1','2024-12-31'))
eiov = eio.values
#%% eio
...
#%% EIO
fig, axs = plt.subplots(2, 2, figsize=(27,16),dpi = 300)
...
plt.suptitle('Mean sea- air CO$_2$ flux Time Series for the Equatorial Indian Ocean (6.5°S-5°N, 49°E-92°E)', fontsize=26)
plt.tight_layout(rect=[0, 0, 1, 0.96]) # Adjust rect to make room for suptitle
plt.savefig('/home/bobco-08/24cl05012/CO2/plot/co2_flux/trend/eio_CO2F',dpi=600)
plt.show()
