...
# -----------------------------
# Function to draw box (with color + custom text position)
# -----------------------------
def draw_box(ax, lon_slice, lat_slice, label, color, text_lon_offset, text_lat_offset):
    ...
    ax.text(
        lon_min + text_lon_offset,
        lat_min + text_lat_offset,
        label,
        color=color,
        fontsize=24,
        fontweight='bold',
...
# -----------------------------
# Draw all regions (custom styling)
# -----------------------------
draw_box(ax, eio_lon_slice, eio_lat_slice, 'EIO',  'k', 3, -2)
draw_box(ax, so_lon_slice,  so_lat_slice,  'NWIO', 'k',   -7.5,3)
draw_box(ax, nas_lon_slice, nas_lat_slice, 'NAS',  'k',  14.5, 2)
draw_box(ax, ans_lon_slice, ans_lat_slice, 'ESIO', 'k', 3, -2)
