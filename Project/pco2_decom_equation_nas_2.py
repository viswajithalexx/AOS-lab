...
sst = sst.sel(lat = slice(22.5,28),lon = slice(56,70))
sss = sss.sel(lat = slice(22.5,28),lon = slice(56,70))
#%% pco2-term
...
plt.title('Observed vs Calculated Year-wise pCO$_2$ of NAS (1994–2024)')
plt.legend(frameon=False)
plt.grid(axis='y', linestyle='--', alpha=0.4)

plt.tight_layout()
plt.savefig("/home/bobco-08/24cl05012/CO2/plot/equation_pco2/valid_plots_eqn/nas/nas_obsvscal",dpi=500,bbox_inches="tight"
)
plt.show()
...
plt.xlabel('Year')
plt.ylabel('ΔpCO$_2$ (µatm)')
plt.title('Observed vs Calculated pCO$_2$ and Residual of NAS (1994–2024)')
plt.legend(frameon=False, ncol=3)
plt.grid(True, linestyle='--', alpha=0.4)

plt.tight_layout()
plt.savefig(
    "/home/bobco-08/24cl05012/CO2/plot/equation_pco2/valid_plots_eqn/nas/nas_obs_cal_res",
    dpi=500,
    bbox_inches="tight"
)
plt.show()
...
plt.xticks(x[::2], years[::2], rotation=45)
plt.ylabel('ΔpCO$_2$ (µatm)')
plt.title('pCO$_2$ Decomposition (JAS - JFM)\nNAS (5–22.5°N, 45–65°E)')
plt.legend(ncol=6, frameon=False)
plt.grid(axis='y', linestyle='--', alpha=0.4)

plt.tight_layout()
plt.savefig(
    "/home/bobco-08/24cl05012/CO2/plot/equation_pco2/valid_plots_eqn/nas/nas_drivers",
    dpi=500,
    bbox_inches="tight"
)
...
plt.title('Monthly Climatology of Surface pCO$_2$ in NAS\n(Peak and Trough ±1 Month Highlighted)')
...
plt.savefig(
    "/home/bobco-08/24cl05012/CO2/plot/equation_pco2/valid_plots_eqn/nas/mon_clim_nas_peak_trough.png",
    dpi=500,
    bbox_inches="tight"
)
plt.show()
...
plt.xlabel('Year')
plt.ylabel('ΔpCO$_2$ (µatm)')
plt.title('Annual Time Series of pCO$_2$ and Drivers (JJAS − JFM)\nNAS (1994–2024)')
plt.legend(ncol=3, frameon=False)
plt.grid(True, linestyle='--', alpha=0.4)

plt.tight_layout()
plt.savefig(
    "/home/bobco-08/24cl05012/CO2/plot/equation_pco2/valid_plots_eqn/nas/nas_annual_timeseries_drivers.png",
