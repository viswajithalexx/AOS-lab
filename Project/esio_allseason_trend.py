...
ax1.scatter(years, esio_dclim, marker='o', color='b', label='Spatially Averaged Mean')
...
# --- 5. Final Layout ---
plt.suptitle('Mean pCO$_2$ Time Series for the Eastern Indian Ocean (5°S-10°N, 92°E-110°E)', fontsize=16)
