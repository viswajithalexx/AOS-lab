...
# plotting 
flux_levels = np.arange(300,450,5)
ftl = np.arange(300,450,10)
fig = plt.figure(figsize=(18,14),dpi = 500)
...
season_lv = np.arange(300,450,5)
slv = np.arange(300,450,10)
#plotting
...
std_lv = np.arange(0,28,1)
stlv = np.arange(0,28,2)
#plotting
