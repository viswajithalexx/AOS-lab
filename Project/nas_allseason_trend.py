...
ax1.plot(years, nas_dclim, marker='o', color='b', label='Spatially Averaged Mean')
...
# --- 5. Final Layout ---
plt.suptitle('Mean pCO$_2$ Time Series for the Northern Arabian Sea (22.5°N-28°N, 56°E-70°E)', fontsize=26)
