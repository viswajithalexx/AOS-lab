...
ax.set_title('Seasonal contrast between JAS and DJF of ΔpCO$_2$ in NAS ',fontsize=18,fontweight = 'bold')
...
y_axis_offset = max((np.array(means))) * -0.86  # small vertical offset from x-axis
