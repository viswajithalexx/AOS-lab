...
dpco2_obs_nas = delta_pco2.values
dpco2_cal_nas = delta_pco2_cal.values
...
plt.title('Observed vs Calculated Year-wise pCO$_2$ Amplitude (JAS-MAM) in NAS (1994–2024)')
plt.xlim(1994,2024)
# plt.ylim(0,60)
