...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 21 10:40:49 2026
...
lon =data['lon']
time = data['time']
dic = data['tco2'].sel(lat = slice(-6.6,8),lon = slice(92,109))
...
plt.title('Observed vs Calculated Year-wise pCO$_2$ of ESIO (1994–2024)')
plt.legend(frameon=False)
plt.grid(axis='y', linestyle='--', alpha=0.4)

plt.tight_layout()
plt.savefig("/home/bobco-08/24cl05012/CO2/plot/equation_pco2/valid_plots_eqn/esio/esio_obsvscal",dpi=500,bbox_inches="tight"
)
plt.show()
