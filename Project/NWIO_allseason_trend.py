...
ax1.scatter(years, nwio_dclim, marker='o', color='b', label='Spatially Averaged Mean')
...
for i in range(len(other_seasons)):
    ...
    ax.plot(years, trend_line_nwio, color='red', linestyle='--', linewidth=2, label=trend_label)
...
# --- 5. Final Layout ---
plt.suptitle('Mean pCO$_2$ Time Series for the Northwestern Indian Ocean (0°-24°N, 30°-70°E)', fontsize=16)
